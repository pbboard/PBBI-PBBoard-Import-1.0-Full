...
class vBulletin4_Importer {
    ...
    public function __construct() {
        ...
        // 2. الاتصال بقاعدة بيانات vBulletin 4 (المصدر)
        ...
        // vB4 غالباً latin1 ولكننا سنجرب utf8mb4 للتوافق، وإذا كانت البيانات مشفرة سنتعامل معها في smartClean
