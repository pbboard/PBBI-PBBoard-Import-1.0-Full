...
class vBulletin3_Importer {
    ...
    public function __construct() {
        ...
        // 2. الاتصال بقاعدة بيانات vBulletin 3 (المصدر)
        ...
        // vB43 غالباً latin1 ولكننا سنجرب utf8mb4 للتوافق، وإذا كانت البيانات مشفرة سنتعامل معها في smartClean
