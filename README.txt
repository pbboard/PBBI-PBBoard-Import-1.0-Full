...
B- Addon Import:
   ...
   2. Navigate to the sidebar: Addons -> Import New Plugin.
...
- Execute: (Update all cache forums at once - Auto-update ebuild the permissions of groups for all sections & forums).
...
* Always perform a full database backup before starting the 
  import process.
* For attachment migration, ensure folders (download & download/avatar) permissions (CHMOD) 
